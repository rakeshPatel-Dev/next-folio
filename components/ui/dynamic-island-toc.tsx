...
export function DynamicIslandTOC({
  selector = "article h2, article h3, article h4, .prose h1, .prose h2, .prose h3, .prose h4, [data-toc]",
  ...
  // Portal to <body> so `fixed` isn't trapped by PageTransition transforms.
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain px-3 pb-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
