...
> = {
  ...
  SiBetterauth: { color: "#18181b", colorDark: "#3f3f46", labelWidth: "group-hover/expand:w-[11ch]" },
  ...
  SiFramer: { color: "#0055ff", colorDark: "#3d7bff", labelWidth: "group-hover/expand:w-[13ch]" },
  ...
  SiPostgresql: { color: "#4169e1", colorDark: "#6495ed", labelWidth: "group-hover/expand:w-[10ch]" },
  ...
  SiResend: { color: "#000000", colorDark: "#3a3a3a", labelWidth: "group-hover/expand:w-[6ch]" },
  SiShadcnui: { color: "#0d1117", colorDark: "#3f3f46", labelWidth: "group-hover/expand:w-[8ch]" },
  SiSentry: { color: "#362d59", colorDark: "#5b4d8a", labelWidth: "group-hover/expand:w-[6ch]" },
  SiSupabase: { color: "#3fcf8e", colorDark: "#1c7c56", iconColor: "#0b2b1f", labelWidth: "group-hover/expand:w-[8ch]" },
  ...
  SiVercel: { color: "#000000", colorDark: "#3a3a3a", labelWidth: "group-hover/expand:w-[6ch]" },
  SiZod: { color: "#3e67b1", colorDark: "#5b8ad4", labelWidth: "group-hover/expand:w-[3ch]" },
