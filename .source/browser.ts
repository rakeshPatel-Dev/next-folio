...
const browserCollections = {
  ...
  docs: create.doc("docs", {"ai-first-development-and-agentic-workflows.mdx": () => import("../content/blogs/ai-first-development-and-agentic-workflows.mdx?collection=docs"), "getting-started-with-nextjs-15.mdx": () => import("../content/blogs/getting-started-with-nextjs-15.mdx?collection=docs"), "imposter-syndrome-reflections.mdx": () => import("../content/blogs/imposter-syndrome-reflections.mdx?collection=docs"), "the-god-of-ai-in-2026-why-anthropic-leads-the-intelligence-race.mdx": () => import("../content/blogs/the-god-of-ai-in-2026-why-anthropic-leads-the-intelligence-race.mdx?collection=docs"), "the-market-dominance-of-mern-in-2026.mdx": () => import("../content/blogs/the-market-dominance-of-mern-in-2026.mdx?collection=docs"), }),
  projects: create.doc("projects", {"academix.mdx": () => import("../content/projects/academix.mdx?collection=projects"), "cinebook.mdx": () => import("../content/projects/cinebook.mdx?collection=projects"), "ghardailo-track.mdx": () => import("../content/projects/ghardailo-track.mdx?collection=projects"), "image-toolkit.mdx": () => import("../content/projects/image-toolkit.mdx?collection=projects"), "ishirablecom.mdx": () => import("../content/projects/ishirablecom.mdx?collection=projects"), "moody-musik.mdx": () => import("../content/projects/moody-musik.mdx?collection=projects"), "solodesk.mdx": () => import("../content/projects/solodesk.mdx?collection=projects"), }),
};
